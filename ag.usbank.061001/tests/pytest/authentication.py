...
def authenticate(target_key: str, target: TargetService):
    ...
    if target.config_url == 'https://apply.usbank.com':
        ...
        pass
    elif target.config_url == 'https://usbank-app.quantummetric.com':
        pass
    elif target.config_url == 'https://usbank-sync.quantummetric.com':
        pass
    elif target.config_url == 'https://www.usbank.com':
        pass
    else:
        pass
