...
def authenticate(target_key: str, target: TargetService):
    ...
    if target.config_url == 'https://account.chase.com':
        pass
    elif target.config_url == 'https://autofinance.chase.com':
        pass
    elif target.config_url == 'https://creditcards.chase.com':
        pass
    elif target.config_url == 'https://locator.chase.com':
        pass
    elif target.config_url == 'https://midas.chase.com':
        pass
        ...
        pass
    elif target.config_url == 'https://secure05b.chase.com':
        pass
    elif target.config_url == 'https://secure07a.chase.com':
        pass
    elif target.config_url == 'https://sites.chase.com':
        pass
    elif target.config_url == 'https://target.chase.com':
        pass
    elif target.config_url == 'https://www.chase.com':
        pass
    else:
        pass
