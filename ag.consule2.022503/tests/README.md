...
### Using Docker
Build docker:
`docker build -t up9-ag.consule2.022503 .`

Run tests:
`docker run -it up9-ag.consule2.022503:latest`

Run tests with service override:
`docker run -it -e TARGET_CARTS=localhost:55000 up9-ag.consule2.022503:latest`
