...
public class TestsFrontEndTest
{
    ...
    @Test
    public void testGetCart12() throws MalformedURLException, IOException
    {
    ...
    public void testGetCatalogue15(final JsonObject json) throws MalformedURLException, IOException
    {
    ...
    public void testGetCategoryHtml06(final JsonObject json) throws MalformedURLException, IOException
    {
        final String size = json.getString("size");
    ...
    public void testGetCustomerOrderHtml16(final JsonObject json) throws MalformedURLException, IOException
    {
    ...
    @Test
    public void testGetCustomersCustomerid18() throws MalformedURLException, IOException
    {
    ...
    @Test
    public void testGetCustomersCustomerid44() throws MalformedURLException, IOException
    {
        // GET http://front-end/login (endp 8)
        final HttpTarget frontEnd = getHttpClient("http://front-end", new Authentication());
        final HttpRequest request = new HttpRequest();
    ...
    public void testGetDetailHtml07(final JsonObject json) throws MalformedURLException, IOException
    {
        final String size = json.getString("size");
        final String tags = json.getString("tags");
    ...
    public void testGetOrdersHref20(final JsonObject json) throws MalformedURLException, IOException
    {
        final String size = json.getString("size");
        final String tags = json.getString("tags");
