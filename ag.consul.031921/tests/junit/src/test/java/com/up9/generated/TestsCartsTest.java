...
public class TestsCartsTest
{
    ...
    public void testDeleteCartsCustomerid22(final JsonObject json) throws MalformedURLException, IOException
    {
    ...
    public void testPatchCartsCustomeridItems25(final JsonObject json) throws MalformedURLException, IOException
    {
        final String address = json.getString("address");
        final String card = json.getString("card");
        final String items = json.getString("items");
