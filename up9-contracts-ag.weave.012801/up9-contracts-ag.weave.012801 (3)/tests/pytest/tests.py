...
class Tests_catalogue(unittest.TestCase):
    ...
    def test_13_get_catalogue(self):
        # GET http://catalogue/catalogue (endp 13)
...
class Tests_edge_router(unittest.TestCase):
    ...
    def test_03_get_catalogue(self):
    ...
    def test_05_get_detail_html(self, data_row):
        id_, = data_row
...
class Tests_user(unittest.TestCase):
    ...
    def test_16_get_customers_id_addresses(self, data_row):
        id_, = data_row

        # GET http://user/customers/{id}/addresses (endp 16)
        user = get_http_target('TARGET_USER', authenticate)
    ...
    def test_17_get_customers_id_cards(self, data_row):
        id_, = data_row

        # GET http://user/customers/{id}/cards (endp 17)
        user = get_http_target('TARGET_USER', authenticate)
