...
public class TestsShippingSockShopTest
{
    ...
    public void testPostShipping021(final JsonObject json) throws MalformedURLException, IOException
    {
        ...
        request.setJsonBody("payload_for_endp_21.json", new Hashtable<String, Object>() {{
            put("$.id", uuidv4());
            put("$.name", name);
        }});
